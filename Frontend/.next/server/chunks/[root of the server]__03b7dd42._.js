...
"[project]/.next-internal/server/app/api/send-email/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
;
const secret = ("TURBOPACK compile-time value", "c03dfacbdc0d7d1db274dc4d346bc94a");
const ivLength = 16;
function encrypt(text) {
    const iv = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomBytes"])(ivLength);
    const cipher = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createCipheriv"])('aes-256-cbc', Buffer.from(secret), iv);
...
function decrypt(text) {
    ...
    const decipher = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createDecipheriv"])('aes-256-cbc', Buffer.from(secret), Buffer.from(ivHex, 'hex'));
...
"[project]/models/Verify.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["models"].Verify || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('Verify', UserSchema);
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Verify$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Verify.ts [app-route] (ecmascript)");
...
async function POST(req) {
    ...
    try {
        ...
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$encryption$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["encrypt"])(payload);
        const verifyUrl = `${("TURBOPACK compile-time value", "https://classyfyed.in")}/api/verify?token=${encodeURIComponent(token)}`;
        const transporter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
            host: 'smtp.zoho.in',
            port: 465,
            secure: true,
            auth: {
                user: ("TURBOPACK compile-time value", "no-reply@classyfyed.com"),
                pass: ("TURBOPACK compile-time value", "1Fqg3NYv2d44")
            }
        });
        await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Verify$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            email
        }, {
            name,
            isVerified: false,
        ...
        await transporter.sendMail({
            from: `"Classyfyed" <${("TURBOPACK compile-time value", "no-reply@classyfyed.com")}>`,
            to: email,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__03b7dd42._.js.map