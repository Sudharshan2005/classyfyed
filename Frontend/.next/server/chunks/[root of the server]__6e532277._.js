...
"[project]/.next-internal/server/app/api/user/[id]/reject/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/user/[id]/reject/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, { params }) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        if (!user) {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 8px; background-color: #ffffff;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${("TURBOPACK compile-time value", "https://classyfyed.in")}/register" style="background: linear-gradient(to right, #194EB4, #AC67DE); color: white; padding: 14px 28px; text-decoration: none; border-radius: 6px; display: inline-block; font-size: 16px;">
              Register Again
            </a>
          </div>
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6e532277._.js.map