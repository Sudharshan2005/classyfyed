...
"[project]/.next-internal/server/app/api/orders/vendor/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/orders/vendor/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (!vendorId || !__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Types.ObjectId.isValid(vendorId)) {
        ...
        const orders = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OrderModel"].find().populate('user').populate('items.product').sort({
            placedAt: -1
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a157fa0b._.js.map