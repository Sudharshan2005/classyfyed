...
"[project]/.next-internal/server/app/api/cart/remove/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/cart/remove/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request) {
    try {
        ...
        const cart = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Cart$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            userId
        });
        if (!cart) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (cart.items.length === 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Cart$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deleteOne({
                userId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
        ...
        await cart.save();
        // Populate productId fields for the response
        const updatedCart = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Cart$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            userId
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__019b30c7._.js.map