...
"[project]/.next-internal/server/app/api/example/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/example/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PUT() {
    try {
        ...
        const oldKey = "model"; // 🔁 Replace with your current field name
        const newKey = "productModel"; // ✅ Replace with your desired field name
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateMany({
            [oldKey]: {
                $exists: true
            }
        }, [
        ...
        return Response.json({
            ...
            message: `Renamed ${oldKey} ➝ ${newKey} in ${result.modifiedCount} documents.`
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__04af54ea._.js.map